...
export default function RegisterEntreprise() {
    ...
    const handleSubmit = (e) => {
        ...
        if (!formData.email || !formData.nom || !formData.SecteurActivité || !formData.mdp) {
            alert('Please fill in all fields');
            return; // Arrêter la soumission du formulaire
        }
    
        fetch('http://localhost:3000/api/entreprise/', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            if (data.message === 'Candidat Added Successfully!') {
                ...
                navigate('/loginEntreprise'); // Navigate to login page
            } else {
            ...
            <MDBRow>
                ...
                <MDBCol col='4' md='6'>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <MDBInput wrapperClass='mb-4' label="Nom de l'entreprise" id='formControlLg' name='nom' type='text' size="lg" labelStyle={{ color: '#FFFFFF' }}  style={{ borderColor: '#FFFFFF' }} onChange={handleChange} />
                        <MDBInput wrapperClass='mb-4' label="SecteurActivité" id='formControlLg' name='SecteurActivité' type='text' size="lg" labelStyle={{ color: '#FFFFFF' }}  style={{ borderColor: '#FFFFFF' }} onChange={handleChange} />
