...
export default function LoginCondidat({ setIsLoggedIn }) {
    ...
    const handleSubmit = (e) => {
        ...
        fetch('http://localhost:3000/logincondidat', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            localStorage.setItem('userId', data._id); // Utilisation de data._id au lieu de data.success._id
            console.log(localStorage.getItem('userId'));
            if (data.success) {
                setIsLoggedIn(true);
               
                navigate('/condidat/DashbordCondidat');
            } else {
                ...
                <MDBCol col='4' md='6'>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='text-center text-md-start mt-4 pt-2'>
                            ...
                            <p className="small fw-bold mt-2 pt-1 mb-2">Don't have an account? <Link to="/registercondidat" className="link-danger">Register</Link></p>
                        </div>
                    </form>
                </MDBCol>
            </MDBRow>
